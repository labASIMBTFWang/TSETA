...
function main() {
	...
	fs.writeFileSync(argv_output_prefix + "_snp" + ".txt", JSON.stringify(ref_snp));
	fs.writeFileSync(argv_output_prefix + "_snv" + ".txt", JSON.stringify(ref_snv));
	fs.writeFileSync(argv_output_prefix + "_snp_indel" + ".txt", JSON.stringify(ref_snp_indel));
	...
	fs.writeFileSync(argv_output_prefix + "_summary.txt", output_text);
}
