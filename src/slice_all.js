...
async function multi_coord(nChr) {
	...
	let ref1_chr_fasta = `tmp/fasta/${r1_name}_${ref1_chr_name}.fa`;
	let ref2_chr_fasta = `tmp/fasta/${r2_name}_${ref2_chr_name}.fa`;
	let s1_chr_fasta = `tmp/fasta/${s1_name}_${s1_chr_name}.fa`;
	let s2_chr_fasta = `tmp/fasta/${s2_name}_${s2_chr_name}.fa`;
	let s3_chr_fasta = `tmp/fasta/${s3_name}_${s3_chr_name}.fa`;
	let s4_chr_fasta = `tmp/fasta/${s4_name}_${s4_chr_name}.fa`;
